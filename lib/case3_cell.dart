...
class _CellScreenState extends State<CellScreen> with CaseScreenHelper {
  ...
  final List<List<String>> _towerPingLogs = [
    ['P-8001', 'Rosie Cordova', 'Market District', '13:55', '92%'],
    ['P-8002', 'Ethan Serrano', 'Market District', '14:00', '88%'],
    ['P-8003', 'Officer Johnson', 'South Ward', '14:05', '95%'],
    ['P-8004', 'Neighbor', 'South Ward', '14:14', '91%'],
    ['P-8005', 'Mark Lowe', 'South Ward', '14:15', '98%'],
    ['P-8006', 'Jose De Leon', 'Industrial Zone', '14:16', '85%'],
    ['P-8007', 'Jose De Leon', 'South Ward', '14:20', '94%'],
    ['P-8008', 'Mark Lowe', 'South Ward', '14:30', '97%'],
    ['P-8009', 'Jose De Leon', 'South Ward', '14:35', '96%'],
    ['P-8010', 'Dispatch', 'Central Hub', '14:40', '100%'],
    ['P-8011', 'Mark Lowe', 'South Ward', '14:41', '98%'],
    ['P-8012', 'Marcus Thorne', 'VIP Hospital', '15:00', '92%'],
    ['P-8013', 'Ethan Serrano', 'Market District', '15:15', '84%'],
    ['P-8014', 'Jose De Leon', 'Industrial Zone', '15:30', '89%'],
    ['P-8015', 'Mark Lowe', 'Industrial Zone', '16:30', '82%'],
    ['P-8016', 'Aron Huang', 'VIP Hospital', '16:45', '95%'],
    ['P-8017', 'Benedict Huang', 'VIP Hospital', '17:00', '90%'],
    ['P-8018', 'Mark Lowe', 'South Ward', '17:15', '96%'],
    ['P-8019', 'Rosie Cordova', 'Market District', '18:00', '91%'],
    ['P-8020', 'Ethan Serrano', 'VIP Hospital', '19:30', '87%'],
    ['P-8021', 'Mark Lowe', 'South Ward', '20:00', '95%'],
    ['P-8022', 'Jose De Leon', 'VIP Hospital', '23:25', '91%'],
    ['P-8023', 'Aron Huang', 'VIP Hospital', '2:00', '94%'],
    ['P-8024', 'Ethan Serrano', 'Market District', '8:00', '85%'],
    ['P-8025', 'Rosie Cordova', 'Market District', '8:05', '89%'],
  ];
  ...
  void initState() {
    ...
    _allLedgerMaps = _towerPingLogs.map((row) {
      return {
        'ping_id': row[0],
        'device_owner': row[1],
        'proximity_zone': row[2],
        'timestamp': row[3],
  ...
  bool _isCellCorrectAnswer(String input) {
    final normalized = _normalizeAnswer(input);

    const acceptedAnswers = {
      'VIP HOSPITAL',
      'THE VIP HOSPITAL',
      'HE WAS AT VIP HOSPITAL',
      'ARON HUANG WAS AT VIP HOSPITAL',
    };
  ...
  void _submitAnswer() async {
    ...
    if (_isCellCorrectAnswer(_answerController.text)) {
            ...
            children: [
              ...
              Positioned(
                ...
                child: _buildOverlayIcon(
                  ...
                  35,
                  "A small, grey metal equipment locker.",
                  'audio/case3/cell/1.mp3',
              ...
              Positioned(
                ...
                child: _buildOverlayIcon(
                  'assets/investigate.png',
                  40,
                  "A horizontal white sign mounted on the metal framework of the tower.",
                  'audio/case3/cell/2.mp3',
        ...
        child: SizedBox(
          ...
          child: Stack(
            children: [
              Positioned.fill(
                child: Image.asset(
                  'assets/Case3/cell_question.png',
                  fit: BoxFit.fill,
                ),
              ),
              Positioned(
              ...
              Positioned(
                ...
                child: const Text(
                  "Trace the signal pings for device owner Aron Huang during the time of the transplant. Where was he during the Harvest?",
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontFamily: 'Consolas',
                    fontSize: 15,
  ...
  Widget _buildQueryView(BoxConstraints constraints) {
    return Stack(
      children: [
        Positioned.fill(
          child: Image.asset('assets/Case3/cell_query.png', fit: BoxFit.fill),
        ),
        Positioned(
          top: 10,
          right: 20,
