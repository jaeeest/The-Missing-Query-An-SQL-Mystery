...
class SkylineScreen extends StatefulWidget {
  const SkylineScreen({super.key});

  @override
  State<SkylineScreen> createState() => _SkylineScreenState();
}

class _SkylineScreenState extends State<SkylineScreen> with CaseScreenHelper {
  ...
  final List<List<String>> _flightManifests = [
    ['SKY-101', 'Sarah Jenkins', '12A', 'BOARDED', '7:00'],
    ['SKY-101', 'Michael Chen', '14C', 'BOARDED', '7:00'],
    ['SKY-202', 'Aurelia Bauer', '02B', 'BOARDED', '8:30'],
    ['SKY-202', 'Rebekah Beck', '05D', 'CANCELLED', '8:30'],
    ['SKY-305', 'Mark Lowe', '04A', 'NO_SHOW', '10:00'],
    ['SKY-305', 'Emanuel Larson', '04B', 'BOARDED', '10:00'],
    ['SKY-305', 'Houston Adams', '11F', 'BOARDED', '10:00'],
    ['SKY-305', 'Orville Guzman', '01A', 'BOARDED', '10:00'],
    ['SKY-410', 'Cedrick Vasquez', '08C', 'BOARDED', '11:15'],
    ['SKY-410', 'Wenjie Yi', '03A', 'BOARDED', '11:15'],
    ['SKY-550', 'Claire Hawkins', '01F', 'BOARDED', '12:45'],
    ['SKY-550', 'Jim Hale', '01E', 'CANCELLED', '12:45'],
    ['SKY-600', 'Susan Rodriguez', '15B', 'NO_SHOW', '13:30'],
    ['SKY-600', 'Misaki Akiyama', '12D', 'BOARDED', '13:30'],
    ['SKY-707', 'Yusuke Honda', '01A', 'BOARDED', '14:00'],
    ['SKY-707', 'Taizo Nohara', '22B', 'BOARDED', '14:00'],
    ['SKY-808', 'Luke Wilkins', '05C', 'BOARDED', '15:30'],
    ['SKY-808', 'Irma Anthony', '19A', 'BOARDED', '15:30'],
    ['SKY-909', 'Jane Werner', '10D', 'BOARDED', '17:00'],
    ['SKY-909', 'Jerry Siong', '08F', 'BOARDED', '17:00'],
    ['SKY-011', 'Raja Too', '02A', 'BOARDED', '18:45'],
    ['SKY-011', 'Ljiljana Eder', '02B', 'BOARDED', '18:45'],
    ['SKY-112', 'Ju Hsieh', '01A', 'BOARDED', '20:15'],
    ['SKY-112', 'Elise Hörmann', '05B', 'BOARDED', '20:15'],
    ['SKY-112', 'Ren Ai', '04C', 'BOARDED', '20:15'],
  ];
  ...
  void initState() {
    ...
    _allLedgerMaps = _flightManifests.map((row) {
      return {
        'flight_no': row[0],
        'name': row[1],
        'seat': row[2],
  ...
  bool _isSkylineCorrectAnswer(String input) {
    final normalized = _normalizeAnswer(input);

    const acceptedAnswers = {
      'NO_SHOW 04A',
      'NO SHOW 04A',
      'MARK LOWE NO_SHOW 04A',
      'MARK LOWE NO SHOW 04A',
      '04A NO_SHOW',
      '04A NO SHOW',
    };
  ...
  void _submitAnswer() async {
    ...
    if (_isSkylineCorrectAnswer(_answerController.text)) {
            ...
            children: [
              ...
              Positioned(
                ...
                child: _buildOverlayIcon(
                  ...
                  35,
                  "Three flight departure screens mounted above the seating area.",
                  'audio/case3/skyline/1.mp3',
        ...
        child: SizedBox(
          ...
          child: Stack(
            children: [
              Positioned.fill(
                child: Image.asset(
                  'assets/Case3/skyline_question.png',
                  fit: BoxFit.fill,
                ),
              ),
              Positioned(
              ...
              Positioned(
                ...
                child: const Text(
                  "Search for passenger Mark Lowe on flight SKY-305. What is his official boarding status and seat number?",
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontFamily: 'Consolas',
                    fontSize: 15,
  ...
  Widget _buildTableView(BoxConstraints constraints) {
    ...
    return Stack(
      children: [
        Positioned.fill(
          child: Image.asset('assets/Case3/flight_manifests.png', fit: BoxFit.fill),
        ),
        Positioned(
          top: 20,
          right: 20,
  ...
  Widget _buildQueryView(BoxConstraints constraints) {
    return Stack(
      children: [
        Positioned.fill(
          child: Image.asset('assets/Case3/skyline_query.png', fit: BoxFit.fill),
        ),
        Positioned(
          top: 10,
          right: 20,
