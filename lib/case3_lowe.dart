...
class _LoweScreenState extends State<LoweScreen> with CaseScreenHelper {
        ...
        child: SizedBox(
          ...
          child: Stack(
            children: [
              Positioned.fill(
                child: Image.asset(
                  'assets/Case3/lowe_question.png',
                  fit: BoxFit.fill,
                ),
              ),
              Positioned(
  ...
  Widget _buildTableView(BoxConstraints constraints) {
    ...
    return Stack(
      children: [
        Positioned.fill(
          child: Image.asset('assets/Case3/smart_home.png', fit: BoxFit.fill),
        ),
        Positioned(
          top: 20,
          right: 20,
  ...
  Widget _buildQueryView(BoxConstraints constraints) {
    return Stack(
      children: [
        Positioned.fill(
          child: Image.asset('assets/Case3/lowe_query.png', fit: BoxFit.fill),
        ),
        Positioned(
          top: 10,
          right: 20,
