      ...
      body: LayoutBuilder(
        builder: (context, constraints) {
          return Stack(
            ...
            children: [
              Positioned.fill(
                child: Image.asset('assets/Case3/map3.png', fit: BoxFit.cover),
              ),
              Positioned(
                top: constraints.maxHeight * 0.18,
                left: constraints.maxWidth * 0.15,
                child: _buildMapLabel(context, 'assets/Case3/skyline.png', 100),
              ),
              Positioned(
                top: constraints.maxHeight * 0.08,
                left: constraints.maxWidth * 0.35,
                child: _buildMapLabel(context, 'assets/Case3/huang.png', 80),
              ),
              Positioned(
                top: constraints.maxHeight * 0.30,
                left: constraints.maxWidth * 0.37,
                child: _buildMapLabel(context, 'assets/Case3/city_police.png', 100),
              ),
              Positioned(
                top: constraints.maxHeight * 0.50,
                left: constraints.maxWidth * 0.53,
                child: _buildMapLabel(context, 'assets/Case3/bank.png', 100),
              ),
              Positioned(
                top: constraints.maxHeight * 0.27,
                left: constraints.maxWidth * 0.75,
                child: _buildMapLabel(context, 'assets/Case3/logistics.png', 100),
              ),
              Positioned(
                top: constraints.maxHeight * 0.48,
                left: constraints.maxWidth * 0.25,
                child: _buildMapLabel(context, 'assets/Case3/cordova.png', 90),
              ),
              Positioned(
                top: constraints.maxHeight * 0.60,
                left: constraints.maxWidth * 0.38,
                child: _buildMapLabel(context, 'assets/Case3/hospital.png', 95),
              ),
              Positioned(
                top: constraints.maxHeight * 0.78,
                left: constraints.maxWidth * 0.50,
                child: _buildMapLabel(context, 'assets/Case3/lowe.png', 85),
              ),
              Positioned(
                top: constraints.maxHeight * 0.52,
                left: constraints.maxWidth * 0.82,
                child: _buildMapLabel(context, 'assets/Case3/cell.png', 80),
              ),
              Positioned(
